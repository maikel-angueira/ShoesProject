...
namespace Systems.Appollo.Shoes.Client.WinForm.Views.Seller
{
    public partial class NewSupplierForm : Form
    {
        ...
        private void ResetView()
        {
            ...
            if (supplierPictureBox.Image != null)
            {
                supplierPictureBox.Image.Dispose();
                supplierPictureBox.Image = null;
            }
        }
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                supplierPictureBox.Image = img;// resizeImage(img);
                supplierPictureBox.SizeMode = PictureBoxSizeMode.StretchImage;
            }
        }
